import { Box, Button, FormControl, InputBase, TextareaAutosize, useTheme, useMediaQuery } from "@mui/material";
...
const CreatePost = () => {
    ...
    return (
        <Box style={{margin: isMediumScreen ? 0 : "50px 100px"}}> 
            <img src={url} alt="CreateBlogImage" 
                style={{
                    width: "100%",
                    height: "50vh",
                    objectFit: 'cover'
            ...
            <FormControl style={{ 
                ...
                <input 
                    ...
                    name="image"
                    onChange={(element) => {
                        console.log(typeof element.target.files);
                        console.log(typeof element.target.files[0]);
